...
const AvadmyofisMomvleli = () => {
    ...
    <div style={{ display: "flex", flexDirection:"column", gap:"25px" }}>
      ...
      <div className={styles.child_age}>
        <label>პაციენტის მდგომარეობა</label>
        <select name="childAges" id="childAges" className={styles.options} onChange={(e) => handleActiveChildAges(e.target.value)}>
          <option value="newbornBaby">არამწოლიარე ქალი</option>
          <option value="ertwlamde">არამწოლიარე მამაკაცი</option>
          <option value="atsplius">მწოლიარე ქალი</option>
          <option value="orzemetibavshvi">მწოლიარე მამაკაცი</option>
          <option value="disabilities">მძიმე მდგომარეობა ქალი/კაცი</option>
        </select>
      </div>
...
export default AvadmyofisMomvleli